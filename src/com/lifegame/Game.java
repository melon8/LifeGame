...
/**
 * 生命游戏规则：如果本细胞死了，周围细胞有3个，那么死细胞复活 如果周围细胞<2或者>3那么活细胞死去 如果周围细胞=2，维持原状态
 * 运用线程池，每一代创建一个线程池，将每一个继承runnable接口的细胞任务加入到线程池中， 执行完全部任务后线程池shutdown
 * 
 * @author Song
 *
 */
public class Game {
	...
	/**
	 * @author Song 内部类细胞线程任务类， checkNeighbor方法，算出周围细胞活着的细胞个数，返回细胞个数；
	 *         run方法中判断下一代细胞生死情况，赋给nextCells[][]
	 */
